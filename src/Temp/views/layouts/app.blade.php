        ...
        <div class="container mx-auto flex justify-between">
            ...
            <div class="flex justify-end">
                @guest
                    ...
                    @endif
                @else
                    <a id="" class="mr-6 py-2 px-3 bg-gray-200 hover:bg-gray-300 rounded-l-full rounded-r-full" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                       v-pre>
